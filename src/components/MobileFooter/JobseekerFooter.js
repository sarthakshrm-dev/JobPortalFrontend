...
import myApplication from '../../images/mobileFooter/jobseeker/myApplication.svg'
			...
			<Navbar fixed="bottom" className="bottom-tab-nav" style={{ paddingTop: '0' }}>
				<Nav className="justify-content-around w-100 footNav " >
					...
					<Nav.Link
						...
						active={location.pathname.includes("/dashboard/jobs/applied")}
						style={{
							color: location.pathname.includes("/dashboard/jobs/applied")
								? "#fff"
								: "rgba(255, 255, 255, 0.74)",
						}}
					...
					>
						<div className={css.pulseContainer}>
							...
							<div className={css.footName}>My Jobs</div>
						</div>
					</Nav.Link>
					<Nav.Link
						as={NavLink}
						to="/dashboard/myApplication"
						active={location.pathname === "/dashboard/myApplication"}
						style={{
							color:
								location.pathname === "/dashboard/myApplication"
									? "#fff"
					...
					>
						<div className={css.footIcons}>
							...
							<img
								id={location.pathname === "/dashboard/myApplication" ? "referralSelect" : "referral"}
								src={myApplication} alt="referral" style={{ width: '25px', height: '25px' }} />
						</div>
						<div className={css.footName}>My Applications</div>
					</Nav.Link>
					<Nav.Link
						as={NavLink}
						to="	/dashboard/viewprofile"
						active={location.pathname === "/dashboard/viewprofile"}
						style={{
							color:
